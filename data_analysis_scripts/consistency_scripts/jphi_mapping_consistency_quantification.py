...
def compute_rmse(array1, array2, x1=None, x2=None):
    ...
    Args:
        array1 (np.ndarray): First profile (e.g. jphi_1).
        array2 (np.ndarray): Second profile (e.g. jphi_2).
...
# Test case A
jphi_list_n_NICE_50_n_TORAX_10 = [eq.time_slice[0].profiles_1d.j_phi for eq in equilibria_n_NICE_50_n_TORAX_10]
...
jphi_list_n_NICE_50_n_TORAX_15 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_50_n_TORAX_15]
...
jphi_list_n_NICE_50_n_TORAX_20 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_50_n_TORAX_20]
...
jphi_list_n_NICE_50_n_TORAX_25 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_50_n_TORAX_25]
...
jphi_list_n_NICE_50_n_TORAX_30 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_50_n_TORAX_30]
...
jphi_list_n_NICE_50_n_TORAX_50 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_50_n_TORAX_50]
...
jphi_list_n_NICE_50_n_TORAX_100 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_50_n_TORAX_100]
...
# Test case B
jphi_list_n_NICE_25_n_TORAX_25 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_25_n_TORAX_25]
...
jphi_list_n_NICE_100_n_TORAX_25 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_100_n_TORAX_25]
...
# Test case C
jphi_list_n_NICE_1000_n_TORAX_10 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_1000_n_TORAX_10]
...
jphi_list_n_NICE_1000_n_TORAX_15 = [eq.time_slice[0].profiles_1d.j_phi for eq in equilibria_n_NICE_1000_n_TORAX_15]
...
jphi_list_n_NICE_1000_n_TORAX_20 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_1000_n_TORAX_20]
...
jphi_list_n_NICE_1000_n_TORAX_25 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_1000_n_TORAX_25]
...
jphi_list_n_NICE_1000_n_TORAX_30 = [eq.time_slice[0].profiles_1d.j_phi for eq in equilibria_n_NICE_1000_n_TORAX_30]
...
jphi_list_n_NICE_1000_n_TORAX_50 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_1000_n_TORAX_50]
...
jphi_list_n_NICE_1000_n_TORAX_100 = [eq.time_slice[0].profiles_1d.j_phi  for eq in equilibria_n_NICE_1000_n_TORAX_100]
...
# Test case A
rmse_n_NICE_50_n_TORAX_10 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_10[0], jphi_list_n_NICE_50_n_TORAX_10[1], rho_tor_norm_list_n_NICE_50_n_TORAX_10[0], rho_tor_norm_list_n_NICE_50_n_TORAX_10[1])

rmse_n_NICE_50_n_TORAX_15 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_15[0], jphi_list_n_NICE_50_n_TORAX_15[1], rho_tor_norm_list_n_NICE_50_n_TORAX_15[0], rho_tor_norm_list_n_NICE_50_n_TORAX_15[1])

rmse_n_NICE_50_n_TORAX_20 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_20[0], jphi_list_n_NICE_50_n_TORAX_20[1], rho_tor_norm_list_n_NICE_50_n_TORAX_20[0], rho_tor_norm_list_n_NICE_50_n_TORAX_20[1])

rmse_n_NICE_50_n_TORAX_25 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_25[0], jphi_list_n_NICE_50_n_TORAX_25[1], rho_tor_norm_list_n_NICE_50_n_TORAX_25[0], rho_tor_norm_list_n_NICE_50_n_TORAX_25[1])

rmse_n_NICE_50_n_TORAX_30 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_30[0], jphi_list_n_NICE_50_n_TORAX_30[1], rho_tor_norm_list_n_NICE_50_n_TORAX_30[0], rho_tor_norm_list_n_NICE_50_n_TORAX_30[1])

rmse_n_NICE_50_n_TORAX_50 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_50[0], jphi_list_n_NICE_50_n_TORAX_50[1], rho_tor_norm_list_n_NICE_50_n_TORAX_50[0], rho_tor_norm_list_n_NICE_50_n_TORAX_50[1])

rmse_n_NICE_50_n_TORAX_100 = compute_rmse(jphi_list_n_NICE_50_n_TORAX_100[0], jphi_list_n_NICE_50_n_TORAX_100[1], rho_tor_norm_list_n_NICE_50_n_TORAX_100[0], rho_tor_norm_list_n_NICE_50_n_TORAX_100[1])


# Test case B
rmse_n_NICE_25_n_TORAX_25 = compute_rmse(jphi_list_n_NICE_25_n_TORAX_25[0], jphi_list_n_NICE_25_n_TORAX_25[1], rho_tor_norm_list_n_NICE_25_n_TORAX_25[0], rho_tor_norm_list_n_NICE_25_n_TORAX_25[1])

rmse_n_NICE_100_n_TORAX_25 = compute_rmse(jphi_list_n_NICE_100_n_TORAX_25[0], jphi_list_n_NICE_100_n_TORAX_25[1], rho_tor_norm_list_n_NICE_100_n_TORAX_25[0], rho_tor_norm_list_n_NICE_100_n_TORAX_25[1])


# Test case C
rmse_n_NICE_1000_n_TORAX_10 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_10 [0], jphi_list_n_NICE_1000_n_TORAX_10 [1], rho_tor_norm_list_n_NICE_1000_n_TORAX_10 [0], rho_tor_norm_list_n_NICE_1000_n_TORAX_10 [1])

rmse_n_NICE_1000_n_TORAX_15 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_15[0], jphi_list_n_NICE_1000_n_TORAX_15[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_15[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_15[1])

rmse_n_NICE_1000_n_TORAX_20 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_20[0], jphi_list_n_NICE_1000_n_TORAX_20[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_20[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_20[1])

rmse_n_NICE_1000_n_TORAX_25 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_25[0], jphi_list_n_NICE_1000_n_TORAX_25[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_25[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_25[1])

rmse_n_NICE_1000_n_TORAX_30 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_30[0], jphi_list_n_NICE_1000_n_TORAX_30[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_30[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_30[1])

rmse_n_NICE_1000_n_TORAX_50 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_50[0], jphi_list_n_NICE_1000_n_TORAX_50[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_50[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_50[1])

rmse_n_NICE_1000_n_TORAX_100 = compute_rmse(jphi_list_n_NICE_1000_n_TORAX_100[0], jphi_list_n_NICE_1000_n_TORAX_100[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_100[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_100[1])
...
c = ax.imshow(rmse_array/1e6, cmap='YlGnBu', aspect='auto', interpolation='nearest')
...
ax.set_title("Consistency data through TORAX: RMSE between post_inverse and post_inverse $j_{\phi}$ for iteration 1, against NICE and TORAX profile resolution")
...
for i in range(len(n_NICE_values)):
    for j in range(len(n_TORAX_values)):
        value = rmse_array[i, j]/1e6
        if not np.isnan(value):
            ax.text(j, i, f"{value:.2e}", ha="center", va="center", color="white" if value > np.nanmax(rmse_array/1e6)/2 else "black")

fig.colorbar(c, ax=ax, label="RMSE $j{\phi}$ (MA $m^{-2}$)")
plt.tight_layout()
plt.show()
