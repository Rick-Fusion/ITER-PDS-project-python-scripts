...
# Test case A
psi_list_n_NICE_50_n_TORAX_10 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] )  for eq in equilibria_n_NICE_50_n_TORAX_10]
...
psi_list_n_NICE_50_n_TORAX_15 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_50_n_TORAX_15]
...
psi_list_n_NICE_50_n_TORAX_20 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_50_n_TORAX_20]
...
psi_list_n_NICE_50_n_TORAX_25 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_50_n_TORAX_25]
...
psi_list_n_NICE_50_n_TORAX_30 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_50_n_TORAX_30]
...
psi_list_n_NICE_50_n_TORAX_50 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_50_n_TORAX_50]
...
psi_list_n_NICE_50_n_TORAX_100 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_50_n_TORAX_100]
...
# Test case B
psi_list_n_NICE_25_n_TORAX_25 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_25_n_TORAX_25]
...
psi_list_n_NICE_100_n_TORAX_25 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_100_n_TORAX_25]
...
# Test case C
psi_list_n_NICE_1000_n_TORAX_10 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_1000_n_TORAX_10]
...
psi_list_n_NICE_1000_n_TORAX_15 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] )for eq in equilibria_n_NICE_1000_n_TORAX_15]
...
psi_list_n_NICE_1000_n_TORAX_20 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_1000_n_TORAX_20]
...
psi_list_n_NICE_1000_n_TORAX_25 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_1000_n_TORAX_25]
...
psi_list_n_NICE_1000_n_TORAX_30 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_1000_n_TORAX_30]
...
psi_list_n_NICE_1000_n_TORAX_50 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_1000_n_TORAX_50]
...
psi_list_n_NICE_1000_n_TORAX_100 = [( eq.time_slice[0].profiles_1d.psi - eq.time_slice[0].profiles_1d.psi[0] ) / ( eq.time_slice[0].profiles_1d.psi[-1] - eq.time_slice[0].profiles_1d.psi[0] ) for eq in equilibria_n_NICE_1000_n_TORAX_100]
...
# Test case A
rmse_n_NICE_50_n_TORAX_10 = compute_rmse(psi_list_n_NICE_50_n_TORAX_10[0], psi_list_n_NICE_50_n_TORAX_10[1], rho_tor_norm_list_n_NICE_50_n_TORAX_10[0], rho_tor_norm_list_n_NICE_50_n_TORAX_10[1])

rmse_n_NICE_50_n_TORAX_15 = compute_rmse(psi_list_n_NICE_50_n_TORAX_15[0], psi_list_n_NICE_50_n_TORAX_15[1], rho_tor_norm_list_n_NICE_50_n_TORAX_15[0], rho_tor_norm_list_n_NICE_50_n_TORAX_15[1])

rmse_n_NICE_50_n_TORAX_20 = compute_rmse(psi_list_n_NICE_50_n_TORAX_20[0], psi_list_n_NICE_50_n_TORAX_20[1], rho_tor_norm_list_n_NICE_50_n_TORAX_20[0], rho_tor_norm_list_n_NICE_50_n_TORAX_20[1])

rmse_n_NICE_50_n_TORAX_25 = compute_rmse(psi_list_n_NICE_50_n_TORAX_25[0], psi_list_n_NICE_50_n_TORAX_25[1], rho_tor_norm_list_n_NICE_50_n_TORAX_25[0], rho_tor_norm_list_n_NICE_50_n_TORAX_25[1])

rmse_n_NICE_50_n_TORAX_30 = compute_rmse(psi_list_n_NICE_50_n_TORAX_30[0], psi_list_n_NICE_50_n_TORAX_30[1], rho_tor_norm_list_n_NICE_50_n_TORAX_30[0], rho_tor_norm_list_n_NICE_50_n_TORAX_30[1])

rmse_n_NICE_50_n_TORAX_50 = compute_rmse(psi_list_n_NICE_50_n_TORAX_50[0], psi_list_n_NICE_50_n_TORAX_50[1], rho_tor_norm_list_n_NICE_50_n_TORAX_50[0], rho_tor_norm_list_n_NICE_50_n_TORAX_50[1])

rmse_n_NICE_50_n_TORAX_100 = compute_rmse(psi_list_n_NICE_50_n_TORAX_100[0], psi_list_n_NICE_50_n_TORAX_100[1], rho_tor_norm_list_n_NICE_50_n_TORAX_100[0], rho_tor_norm_list_n_NICE_50_n_TORAX_100[1])


# Test case B
rmse_n_NICE_25_n_TORAX_25 = compute_rmse(psi_list_n_NICE_25_n_TORAX_25[0], psi_list_n_NICE_25_n_TORAX_25[1], rho_tor_norm_list_n_NICE_25_n_TORAX_25[0], rho_tor_norm_list_n_NICE_25_n_TORAX_25[1])

rmse_n_NICE_100_n_TORAX_25 = compute_rmse(psi_list_n_NICE_100_n_TORAX_25[0], psi_list_n_NICE_100_n_TORAX_25[1], rho_tor_norm_list_n_NICE_100_n_TORAX_25[0], rho_tor_norm_list_n_NICE_100_n_TORAX_25[1])


# Test case C
rmse_n_NICE_1000_n_TORAX_10 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_10 [0], psi_list_n_NICE_1000_n_TORAX_10 [1], rho_tor_norm_list_n_NICE_1000_n_TORAX_10 [0], rho_tor_norm_list_n_NICE_1000_n_TORAX_10 [1])

rmse_n_NICE_1000_n_TORAX_15 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_15[0], psi_list_n_NICE_1000_n_TORAX_15[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_15[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_15[1])

rmse_n_NICE_1000_n_TORAX_20 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_20[0], psi_list_n_NICE_1000_n_TORAX_20[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_20[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_20[1])

rmse_n_NICE_1000_n_TORAX_25 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_25[0], psi_list_n_NICE_1000_n_TORAX_25[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_25[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_25[1])

rmse_n_NICE_1000_n_TORAX_30 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_30[0], psi_list_n_NICE_1000_n_TORAX_30[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_30[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_30[1])

rmse_n_NICE_1000_n_TORAX_50 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_50[0], psi_list_n_NICE_1000_n_TORAX_50[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_50[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_50[1])

rmse_n_NICE_1000_n_TORAX_100 = compute_rmse(psi_list_n_NICE_1000_n_TORAX_100[0], psi_list_n_NICE_1000_n_TORAX_100[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_100[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_100[1])
...
ax.set_xticklabels(n_TORAX_values, fontsize=18)
ax.set_yticklabels(n_NICE_values, fontsize=18)
ax.set_xlabel("n_TORAX", fontsize=18)
ax.set_ylabel("n_NICE", fontsize=18)
#ax.set_title("Consistency data through TORAX: RMSE between post_inverse and post_inverse $\psi_{norm}$ for iteration 1, against NICE and TORAX profile resolution")
...
for i in range(len(n_NICE_values)):
    for j in range(len(n_TORAX_values)):
        ...
        if not np.isnan(value):
            ax.text(j, i, f"{value:.2e}", ha="center", va="center", color="white" if value > np.nanmax(rmse_array)/2 else "black",fontsize=14)



# Colorbar with label font size
cbar = fig.colorbar(c, ax=ax, label="RMSE $\psi_{norm}$ (Wb)")
cbar.ax.tick_params(labelsize=18)  # Colorbar tick font size
cbar.set_label("RMSE $\psi_{norm}$ (Wb)", fontsize=18)

# Force scientific notation on the colorbar ticks
formatter = ScalarFormatter()
formatter.set_scientific(True)
formatter.set_powerlimits((-2, -1))  # Show scientific notation if exponent between 10^-2 and 10^2
