...
def compute_rmse(array1, array2, x1=None, x2=None):
    ...
    Args:
        array1 (np.ndarray): First profile (e.g. gm7_1).
        array2 (np.ndarray): Second profile (e.g. gm7_2).
...
# Test case A
gm7_list_n_NICE_50_n_TORAX_10 = [eq.time_slice[0].profiles_1d.gm7 for eq in equilibria_n_NICE_50_n_TORAX_10]
...
gm7_list_n_NICE_50_n_TORAX_15 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_50_n_TORAX_15]
...
gm7_list_n_NICE_50_n_TORAX_20 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_50_n_TORAX_20]
...
gm7_list_n_NICE_50_n_TORAX_25 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_50_n_TORAX_25]
...
gm7_list_n_NICE_50_n_TORAX_30 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_50_n_TORAX_30]
...
gm7_list_n_NICE_50_n_TORAX_50 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_50_n_TORAX_50]
...
gm7_list_n_NICE_50_n_TORAX_100 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_50_n_TORAX_100]
...
# Test case B
gm7_list_n_NICE_25_n_TORAX_25 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_25_n_TORAX_25]
...
gm7_list_n_NICE_100_n_TORAX_25 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_100_n_TORAX_25]
...
# Test case C
gm7_list_n_NICE_1000_n_TORAX_10 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_1000_n_TORAX_10]
...
gm7_list_n_NICE_1000_n_TORAX_15 = [eq.time_slice[0].profiles_1d.gm7 for eq in equilibria_n_NICE_1000_n_TORAX_15]
...
gm7_list_n_NICE_1000_n_TORAX_20 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_1000_n_TORAX_20]
...
gm7_list_n_NICE_1000_n_TORAX_25 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_1000_n_TORAX_25]
...
gm7_list_n_NICE_1000_n_TORAX_30 = [eq.time_slice[0].profiles_1d.gm7 for eq in equilibria_n_NICE_1000_n_TORAX_30]
...
gm7_list_n_NICE_1000_n_TORAX_50 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_1000_n_TORAX_50]
...
gm7_list_n_NICE_1000_n_TORAX_100 = [eq.time_slice[0].profiles_1d.gm7  for eq in equilibria_n_NICE_1000_n_TORAX_100]
...
# Test case A
rmse_n_NICE_50_n_TORAX_10 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_10[0], gm7_list_n_NICE_50_n_TORAX_10[1], rho_tor_norm_list_n_NICE_50_n_TORAX_10[0], rho_tor_norm_list_n_NICE_50_n_TORAX_10[1])

rmse_n_NICE_50_n_TORAX_15 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_15[0], gm7_list_n_NICE_50_n_TORAX_15[1], rho_tor_norm_list_n_NICE_50_n_TORAX_15[0], rho_tor_norm_list_n_NICE_50_n_TORAX_15[1])

rmse_n_NICE_50_n_TORAX_20 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_20[0], gm7_list_n_NICE_50_n_TORAX_20[1], rho_tor_norm_list_n_NICE_50_n_TORAX_20[0], rho_tor_norm_list_n_NICE_50_n_TORAX_20[1])

rmse_n_NICE_50_n_TORAX_25 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_25[0], gm7_list_n_NICE_50_n_TORAX_25[1], rho_tor_norm_list_n_NICE_50_n_TORAX_25[0], rho_tor_norm_list_n_NICE_50_n_TORAX_25[1])

rmse_n_NICE_50_n_TORAX_30 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_30[0], gm7_list_n_NICE_50_n_TORAX_30[1], rho_tor_norm_list_n_NICE_50_n_TORAX_30[0], rho_tor_norm_list_n_NICE_50_n_TORAX_30[1])

rmse_n_NICE_50_n_TORAX_50 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_50[0], gm7_list_n_NICE_50_n_TORAX_50[1], rho_tor_norm_list_n_NICE_50_n_TORAX_50[0], rho_tor_norm_list_n_NICE_50_n_TORAX_50[1])

rmse_n_NICE_50_n_TORAX_100 = compute_rmse(gm7_list_n_NICE_50_n_TORAX_100[0], gm7_list_n_NICE_50_n_TORAX_100[1], rho_tor_norm_list_n_NICE_50_n_TORAX_100[0], rho_tor_norm_list_n_NICE_50_n_TORAX_100[1])


# Test case B
rmse_n_NICE_25_n_TORAX_25 = compute_rmse(gm7_list_n_NICE_25_n_TORAX_25[0], gm7_list_n_NICE_25_n_TORAX_25[1], rho_tor_norm_list_n_NICE_25_n_TORAX_25[0], rho_tor_norm_list_n_NICE_25_n_TORAX_25[1])

rmse_n_NICE_100_n_TORAX_25 = compute_rmse(gm7_list_n_NICE_100_n_TORAX_25[0], gm7_list_n_NICE_100_n_TORAX_25[1], rho_tor_norm_list_n_NICE_100_n_TORAX_25[0], rho_tor_norm_list_n_NICE_100_n_TORAX_25[1])


# Test case C
rmse_n_NICE_1000_n_TORAX_10 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_10 [0], gm7_list_n_NICE_1000_n_TORAX_10 [1], rho_tor_norm_list_n_NICE_1000_n_TORAX_10 [0], rho_tor_norm_list_n_NICE_1000_n_TORAX_10 [1])

rmse_n_NICE_1000_n_TORAX_15 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_15[0], gm7_list_n_NICE_1000_n_TORAX_15[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_15[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_15[1])

rmse_n_NICE_1000_n_TORAX_20 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_20[0], gm7_list_n_NICE_1000_n_TORAX_20[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_20[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_20[1])

rmse_n_NICE_1000_n_TORAX_25 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_25[0], gm7_list_n_NICE_1000_n_TORAX_25[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_25[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_25[1])

rmse_n_NICE_1000_n_TORAX_30 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_30[0], gm7_list_n_NICE_1000_n_TORAX_30[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_30[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_30[1])

rmse_n_NICE_1000_n_TORAX_50 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_50[0], gm7_list_n_NICE_1000_n_TORAX_50[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_50[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_50[1])

rmse_n_NICE_1000_n_TORAX_100 = compute_rmse(gm7_list_n_NICE_1000_n_TORAX_100[0], gm7_list_n_NICE_1000_n_TORAX_100[1], rho_tor_norm_list_n_NICE_1000_n_TORAX_100[0], rho_tor_norm_list_n_NICE_1000_n_TORAX_100[1])
...
ax.set_title("Consistency data through TORAX: RMSE between post_inverse and post_inverse $gm7$ for iteration 1, against NICE and TORAX profile resolution")
...
fig.colorbar(c, ax=ax, label="RMSE $gm7$ (IDS units))")
plt.tight_layout()
plt.show()
