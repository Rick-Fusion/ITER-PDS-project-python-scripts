...
# Test case C: pprime convergence --> fixed n_NICE = 1000 
...
# take for all sub cases the pprime and rho_tor_norm from each iteration


pprime_list_n_TORAX_10 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_10
]
...
pprime_list_n_TORAX_15 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_15
]
...
pprime_list_n_TORAX_20 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_20
]
...
pprime_list_n_TORAX_25 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_25
]
...
pprime_list_n_TORAX_30 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_30
]
...
pprime_list_n_TORAX_50 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_50
]
...
pprime_list_n_TORAX_100 = [
    eq.time_slice[0].profiles_1d.dpressure_dpsi for eq in equilibria_n_TORAX_100
]
...
rmse_pprime_list_n_TORAX_10 = [
    compute_rmse(pprime_list_n_TORAX_10[i-1], pprime_list_n_TORAX_10[i],
                 rho_tor_norm_list_n_TORAX_10[i-1], rho_tor_norm_list_n_TORAX_10[i])
    for i in range(1, len(pprime_list_n_TORAX_10))
]


rmse_pprime_list_n_TORAX_15 = [
    compute_rmse(pprime_list_n_TORAX_15[i-1], pprime_list_n_TORAX_15[i],
                 rho_tor_norm_list_n_TORAX_15[i-1], rho_tor_norm_list_n_TORAX_15[i])
    for i in range(1, len(pprime_list_n_TORAX_15))
]

rmse_pprime_list_n_TORAX_20 = [
    compute_rmse(pprime_list_n_TORAX_20[i-1], pprime_list_n_TORAX_20[i],
                 rho_tor_norm_list_n_TORAX_20[i-1], rho_tor_norm_list_n_TORAX_20[i])
    for i in range(1, len(pprime_list_n_TORAX_20))
]


rmse_pprime_list_n_TORAX_25 = [
    compute_rmse(pprime_list_n_TORAX_25[i-1], pprime_list_n_TORAX_25[i],
                 rho_tor_norm_list_n_TORAX_25[i-1], rho_tor_norm_list_n_TORAX_25[i])
    for i in range(1, len(pprime_list_n_TORAX_25))
]

rmse_pprime_list_n_TORAX_30 = [
    compute_rmse(pprime_list_n_TORAX_30[i-1], pprime_list_n_TORAX_30[i],
                 rho_tor_norm_list_n_TORAX_30[i-1], rho_tor_norm_list_n_TORAX_30[i])
    for i in range(1, len(pprime_list_n_TORAX_30))
]

rmse_pprime_list_n_TORAX_50 = [
    compute_rmse(pprime_list_n_TORAX_50[i-1], pprime_list_n_TORAX_50[i],
                 rho_tor_norm_list_n_TORAX_50[i-1], rho_tor_norm_list_n_TORAX_50[i])
    for i in range(1, len(pprime_list_n_TORAX_50))
]


rmse_pprime_list_n_TORAX_100 = [
    compute_rmse(pprime_list_n_TORAX_100[i-1], pprime_list_n_TORAX_100[i],
                 rho_tor_norm_list_n_TORAX_100[i-1], rho_tor_norm_list_n_TORAX_100[i])
    for i in range(1, len(pprime_list_n_TORAX_100))
]
...
rmse_data = {
    10: rmse_pprime_list_n_TORAX_10,
    15: rmse_pprime_list_n_TORAX_15,
    20: rmse_pprime_list_n_TORAX_20,
    25: rmse_pprime_list_n_TORAX_25,
    30: rmse_pprime_list_n_TORAX_30,
    50: rmse_pprime_list_n_TORAX_50,
    100: rmse_pprime_list_n_TORAX_100,
}
