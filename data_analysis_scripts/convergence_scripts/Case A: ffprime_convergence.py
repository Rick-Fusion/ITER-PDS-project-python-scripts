...
# Test case A: ffprime convergence --> fixed n_NICE = 50 
...
iteration_numbers = list(range(1, 1 + len(rmse_ffprime_list_n_TORAX_10)))
...
plt.title("Case A: RMSE of $ff'$ profiles between successive iterations\nfor varying $n_{TORAX}$ (fixed $n_{NICE}=50$)")
plt.yscale('log')
