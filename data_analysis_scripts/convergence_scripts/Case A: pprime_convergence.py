...
# Test case A: pprime convergence --> fixed n_NICE = 50 
...
iteration_numbers = list(range(1, 1 + len(rmse_pprime_list_n_TORAX_10)))
...
plt.title("Case A: RMSE of $p'$ profiles between successive iterations\nfor varying $n_{TORAX}$ (fixed $n_{NICE}=50$)")
plt.yscale('log')
