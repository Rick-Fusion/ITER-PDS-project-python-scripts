...
However, this plotting script is mainly used to analyse convergence of psi, p' and ff' 
If you would like to compare 1D profiles between input and output of TORAX, you should look at 1D_profiles_over_time_2, where you can plot the 1D profiles that you expect to be constant throughout TORAX.


The 1D profiles that are currently plotted in this script include: 
- dpressure_dpsi / pprime / p' profiles vs psi_norm   (can be changed to psi or rho_tor_norm or rho_tor)
- f_df_dpsi / ffprime / ff' profiles vs psi_norm      (can be changed to psi or rho_tor_norm or rho_tor)
- pressure vs psi_norm
- psi vs rho_tor_norm
...
if use_entry_1:
    entry_1 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_1/post_torax","r")
    eq_1 = entry_1.get("equilibrium", lazy=True)
    time_1 = eq_1.time
    print(f"## Time slices in eq_1 = {len(time_1)}##")
if use_entry_2:
    entry_2 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_2/post_torax","r")
    eq_2 = entry_2.get("equilibrium", lazy=True)
    time_2 = eq_2.time
    print(f"## Time slices in eq_2 = {len(time_2)}##")

if use_entry_3:
    entry_3 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_3/post_torax","r")
    eq_3 = entry_3.get("equilibrium", lazy=True)
    time_3 = eq_3.time
    print(f"## Time slices in eq_3 = {len(time_3)}##")
if use_entry_4:
    entry_4 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_4/post_torax","r")
    eq_4 = entry_4.get("equilibrium", lazy=True)
    time_4 = eq_4.time
    print(f"## Time slices in eq_4 = {len(time_4)}##")
if use_entry_5:
    entry_5 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_5/post_torax","r")
    eq_5 = entry_5.get("equilibrium", lazy=True)
    time_5 = eq_5.time
    print(f"## Time slices in eq_5 = {len(time_5)}##")
if use_entry_6:
    entry_6 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_6/post_torax","r")
    eq_6 = entry_6.get("equilibrium", lazy=True)
    time_6 = eq_6.time
    print(f"## Time slices in eq_6 = {len(time_6)}##")
if use_entry_7:
    entry_7 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_7/post_torax","r")
    eq_7 = entry_7.get("equilibrium", lazy=True)
    time_7 = eq_7.time
    print(f"## Time slices in eq_7 = {len(time_7)}##")
if use_entry_8:
    entry_8 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_8/post_torax","r")
    eq_8 = entry_8.get("equilibrium", lazy=True)
    time_8 = eq_8.time
    print(f"## Time slices in eq_8 = {len(time_8)}##")
if use_entry_9:
    entry_9 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_9/post_torax","r")
    eq_9 = entry_9.get("equilibrium", lazy=True)
    time_9 = eq_9.time
    print(f"## Time slices in eq_9 = {len(time_9)}##")
if use_entry_10:
    entry_10 = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_20/iteration_10/post_torax","r")
...
fig, ((ax1 , ax2), (ax3 , ax4)) = plt.subplots(2,2, figsize=(10, 20), gridspec_kw={'wspace': 0.2, 'hspace': 0.5})
plt.subplots_adjust(bottom=0.1)  # Adjust for slider space

# Initial plot data for time slice 0

if use_entry_0:
    pprime_plot_0, = ax1.plot([], [], '-', color="green", label="it=0")
    ffprime_plot_0, = ax2.plot([], [], '-', color="green", label="it=0")
    pressure_plot_0, = ax3.plot([], [], '-', color="green", label="it=0")
    psi_plot_0, = ax4.plot([], [], '-', color="green", label="it=0")

if use_entry_1:
    pprime_plot_1, = ax1.plot([], [], '-', color="red", label="it=1")
    ffprime_plot_1, = ax2.plot([], [], '-', color="red", label="it=1")
    pressure_plot_1, = ax3.plot([], [], '-', color="red", label="it=1")
    psi_plot_1, = ax4.plot([], [], '-', color="red", label="it=1")

if use_entry_2:
    pprime_plot_2, = ax1.plot([], [], '-', color="blue", label="it=2")
    ffprime_plot_2, = ax2.plot([], [], '-', color="blue", label="it=2")
    pressure_plot_2, = ax3.plot([], [], '-', color="blue", label="it=2")
    psi_plot_2, = ax4.plot([], [], '-', color="blue", label="it=2")

if use_entry_3:
    pprime_plot_3, = ax1.plot([], [], '-', color="magenta", label="it=3")
    ffprime_plot_3, = ax2.plot([], [], '-', color="magenta", label="it=3")
    pressure_plot_3, = ax3.plot([], [], '-', color="magenta", label="it=3")
    psi_plot_3, = ax4.plot([], [], '-', color="magenta", label="it=3")
 
if use_entry_4:
    pprime_plot_4, = ax1.plot([], [], '-', color='yellow', label="it=4")
    ffprime_plot_4, = ax2.plot([], [], '-', color='yellow', label="it=4")
    pressure_plot_4, = ax3.plot([], [], '-', color="yellow", label="it=4")
    psi_plot_4, = ax4.plot([], [], '-', color="yellow", label="it=4")

if use_entry_5:
    pprime_plot_5, = ax1.plot([], [], '-', color='black', label="it=5")
    ffprime_plot_5, = ax2.plot([], [], '-', color='black', label="it=5")
    pressure_plot_5, = ax3.plot([], [], '-', color="black", label="it=5")
    psi_plot_5, = ax4.plot([], [], '-', color="black", label="it=5")

if use_entry_6:
    pprime_plot_6, = ax1.plot([], [], '-',  label="it=6")
    ffprime_plot_6, = ax2.plot([], [], '-',  label="it=6")
    pressure_plot_6, = ax3.plot([], [], '-',  label="it=6")
    psi_plot_6, = ax4.plot([], [], '-', label="it=6")

if use_entry_7:
    pprime_plot_7, = ax1.plot([], [], '-', label="it=7")
    ffprime_plot_7, = ax2.plot([], [], '-',  label="it=7")
    pressure_plot_7, = ax3.plot([], [], '-',  label="it=7")
    psi_plot_7, = ax4.plot([], [], '-',  label="it=7")
 
if use_entry_8:
    pprime_plot_8, = ax1.plot([], [], '-',  label="it=8")
    ffprime_plot_8, = ax2.plot([], [], '-',  label="it=8")
    pressure_plot_8, = ax3.plot([], [], '-',  label="it=8")
    psi_plot_8, = ax4.plot([], [], '-', label="it=8")

if use_entry_9:
    pprime_plot_9, = ax1.plot([], [], '-',  label="it=9")
    ffprime_plot_9, = ax2.plot([], [], '-',  label="it=9")
    pressure_plot_9, = ax3.plot([], [], '-',  label="it=9")
    psi_plot_9, = ax4.plot([], [], '-',  label="it=9")

if use_entry_10:
    pprime_plot_10, = ax1.plot([], [], '-', label="it=10")
    ffprime_plot_10, = ax2.plot([], [], '-', label="it=10")
    pressure_plot_10, = ax3.plot([], [], '-', label="it=10")
    psi_plot_10, = ax4.plot([], [], '-', label="it=10")
...
def update_plot(i):
    ...
    if use_entry_0:
        ...
        pressure_plot_0.set_data(psi_norm_0, pressure_0)
        psi_plot_0.set_data(rho_tor_norm_0, psi_0)
    

    if use_entry_1:
        pprime_plot_1.set_data(psi_norm_1, pprime_1)
        ffprime_plot_1.set_data(psi_norm_1, ffprime_1)
        pressure_plot_1.set_data(psi_norm_1, pressure_1)
        psi_plot_1.set_data(rho_tor_norm_1, psi_1)

    if use_entry_2:
        pprime_plot_2.set_data(psi_norm_2, pprime_2)
        ffprime_plot_2.set_data(psi_norm_2, ffprime_2)
        pressure_plot_2.set_data(psi_norm_2, pressure_2)
        psi_plot_2.set_data(rho_tor_norm_2, psi_2)
    ...
    if use_entry_3:
        ...
        psi_plot_3.set_data(rho_tor_norm_3, psi_3)
    ...
    if use_entry_4:
        ...
        psi_plot_4.set_data(rho_tor_norm_4, psi_4)
    ...
    if use_entry_5:
        ...
        psi_plot_5.set_data(rho_tor_norm_5, psi_5)
    ...
    if use_entry_6:
        ...
        psi_plot_6.set_data(rho_tor_norm_6, psi_6)
    ...
    if use_entry_7:
        ...
        psi_plot_7.set_data(rho_tor_norm_7, psi_7)
    ...
    if use_entry_8:
        ...
        psi_plot_8.set_data(rho_tor_norm_8, psi_8)
    ...
    if use_entry_9:
        ...
        psi_plot_9.set_data(rho_tor_norm_9, psi_9)
    ...
    if use_entry_10:
        ...
        psi_plot_10.set_data(rho_tor_norm_10, psi_10)

    

    # Update title with time
    ax1.set_title(f"p' profile")    
    ax2.set_title(f"ff' profile")    
    ax3.set_title(f"pressure profile")
    ax4.set_title(f" $\psi$ profile")

    # Set the main title
    fig.suptitle(f"1D profiles post torax for multiple iterations at time = {time[time_idx]:.2f}s", fontsize=14)
    ...
    ax3.set_xlabel(r"$\psi_{norm}$")
    ax3.set_ylabel(r"pressure (Pa) ")
    #ax3.set_xlim(0, 1)
    #ax3.set_ylim(-1, 1)
    ax3.relim()
