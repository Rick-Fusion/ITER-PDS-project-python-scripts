...
time_slices_array = np.linspace(225.00319561,225.00319561,1)


# Open entry to read from
entry_in = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_6/initial_data","r")
entry_out = imas.DBEntry("imas:hdf5?path=/home/ITER/vanschr/investigation_nice_inv_torax_coupling_scheme/test_7/initial_data","w")
